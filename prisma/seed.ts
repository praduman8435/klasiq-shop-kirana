...
const CATALOG: CategorySeed[] = [
  ...
  },
  {
    ...
    products: [
      {
        slug: "mens-cotton-vest",
        name: "Men's Cotton Vest",
        description: "Soft cotton vest, all-day comfort.",
        variants: [
          { size: "M", priceInPaise: rupees(120), stockQuantity: 12 },
          { size: "L", priceInPaise: rupees(120), stockQuantity: 12 },
          { size: "XL", priceInPaise: rupees(130), stockQuantity: 8 },
        ],
      },
      {
        slug: "cotton-handkerchiefs",
        name: "Cotton Handkerchiefs",
        description: "Soft cotton hankies, pack of 3.",
        variants: [
          { size: "Pack of 3", priceInPaise: rupees(99), stockQuantity: 20 },
        ],
      },
      {
        slug: "mens-boxer-shorts",
        name: "Men's Boxer Shorts",
        description: "Breathable cotton boxer shorts.",
        variants: [
          { size: "M", priceInPaise: rupees(220), stockQuantity: 8 },
          { size: "L", priceInPaise: rupees(220), stockQuantity: 8 },
          { size: "XL", priceInPaise: rupees(240), stockQuantity: 5 },
        ],
      },
      {
        slug: "womens-cotton-panties",
        name: "Women's Cotton Panties",
        description: "Everyday cotton panties, pack of 3.",
        variants: [
          { size: "S", priceInPaise: rupees(249), stockQuantity: 8 },
          { size: "M", priceInPaise: rupees(249), stockQuantity: 10 },
          { size: "L", priceInPaise: rupees(249), stockQuantity: 8 },
        ],
      },
      {
        slug: "womens-cotton-bra",
        name: "Women's Everyday Bra",
        description: "Soft padded bra with lace trim.",
        variants: [
          { size: "32B", priceInPaise: rupees(299), stockQuantity: 6 },
          { size: "34B", priceInPaise: rupees(299), stockQuantity: 8 },
          { size: "36B", priceInPaise: rupees(299), stockQuantity: 6 },
        ],
      },
      {
        slug: "camisole",
        name: "Cotton Camisole",
        description: "Soft cotton slip for under kurtis.",
        variants: [
          { size: "M", priceInPaise: rupees(199), stockQuantity: 8 },
          { size: "L", priceInPaise: rupees(199), stockQuantity: 8 },
        ],
      },
      {
        slug: "baby-bodysuit",
        name: "Baby Cotton Bodysuit",
        description: "Soft short-sleeve cotton bodysuits, pack of 2.",
        variants: [
          { size: "0-6 months", priceInPaise: rupees(199), stockQuantity: 10 },
          { size: "6-12 months", priceInPaise: rupees(219), stockQuantity: 10 },
        ],
      },
      {
        slug: "cotton-socks",
        name: "Cotton Socks",
        description: "Ankle-length cotton socks, pack of 3 pairs.",
        variants: [
          { size: "Free size", priceInPaise: rupees(149), stockQuantity: 15 },
        ],
      },
    ],
  },
